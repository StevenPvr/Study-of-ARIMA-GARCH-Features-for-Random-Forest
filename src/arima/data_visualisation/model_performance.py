...
from src.constants import (
    ...
    PLOT_ALPHA_LIGHT,
    PLOT_COLOR_ACTUAL,
    PLOT_COLOR_PREDICTION,
    PLOT_COLOR_RESIDUAL,
    PLOT_COLOR_SPLIT_LINE,
    PLOT_COLOR_TEST,
    PLOT_COLOR_TRAIN,
    PLOT_FONTSIZE_AXIS,
    PLOT_FONTSIZE_LABEL,
    ...
    PLOT_MAX_POINTS_SUBSAMPLE,
    PLOT_TEXTBOX_STYLE_INFO,
    STATISTICS_PRECISION_DEFAULT,
)
...
from .data_loading import load_predictions_with_columns, load_predictions_with_split
...
def plot_fitted_vs_actual(
    ...
    output_file: str,
    max_points: int | None = PLOT_MAX_POINTS_SUBSAMPLE,
) -> None:
    ...
    add_metrics_textbox(
        ...
        metrics,
        position=(0.02, 0.98),
        precision=STATISTICS_PRECISION_DEFAULT,
        style=PLOT_TEXTBOX_STYLE_INFO,
    )
...
def _plot_train_test_predictions(
    ...
    if not test_df.empty:
        ax.plot(
            ...
            test_df["y_true"],
            color=PLOT_COLOR_TEST,
            linewidth=PLOT_LINEWIDTH_DEFAULT + 0.5,
            alpha=PLOT_ALPHA_DEFAULT,
            label="Actual (test)",
        )
        ax.plot(
...
def plot_forecast_errors(
    ...
    axes[0].set_xlabel("Date", fontsize=PLOT_FONTSIZE_AXIS)
    axes[0].set_ylabel("Forecast Error", fontsize=PLOT_FONTSIZE_AXIS)
    ...
    axes[1].set_xlabel("Forecast Error", fontsize=PLOT_FONTSIZE_AXIS)
    axes[1].set_ylabel("Frequency", fontsize=PLOT_FONTSIZE_AXIS)
