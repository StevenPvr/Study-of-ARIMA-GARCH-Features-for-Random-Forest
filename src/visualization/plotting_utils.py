...
def format_date_axis(
    ...
    *,
    ...
    rotation: float = DATE_AXIS_ROTATION,
    ha: str = "right",
) -> None:
    ...
    if minor_locator is None:
        minor_locator = mdates.MonthLocator(DATE_AXIS_YEAR_LOCATOR_MONTHS)
...
def format_seasonal_axis_daily(ax: Axes, rotation: float = DATE_AXIS_ROTATION) -> None:
    ...
    Args:
        ...
        rotation: Label rotation angle in degrees.
    """
    from src.constants import DATE_AXIS_DAILY_MONTHS

    ax.xaxis.set_major_locator(mdates.MonthLocator(DATE_AXIS_DAILY_MONTHS))
...
def prepare_temporal_axis(
    ...
    try:
        ...
        dates_values = dates_clean.values if hasattr(dates_clean, "values") else dates_clean
...
def add_zero_line(
    ...
    *,
    color: str = "black",
    linewidth: float = PLOT_LINEWIDTH_THIN,
    linestyle: str = "--",
    alpha: float = 0.5,
    **kwargs: Any,
) -> None:
...
def plot_histogram_with_normal_overlay(
    ...
    **kwargs: Any,
    ...
    """Plot histogram with fitted normal distribution overlay.
    ...
    Args:
        ...
        fit_color: Color for normal fit curve.
    ...
    normal_fit = stats.norm.pdf(x_range, mean, std)
...
def plot_qq_normal(
    ...
    **kwargs: Any,
    ...
    if show_correlation:
        from src.constants import PLOT_TEXTBOX_STYLE_DEFAULT
...
def add_statistics_textbox(
    ...
    **text_kwargs: Any,
    ...
    if style is None:
        style = PLOT_TEXTBOX_STYLE_DEFAULT
...
def get_test_result_style(
    ...
    """
    from src.constants import PLOT_TEXTBOX_STYLE_ERROR, PLOT_TEXTBOX_STYLE_SUCCESS

    if p_value > alpha:
        return PLOT_TEXTBOX_STYLE_SUCCESS
    return PLOT_TEXTBOX_STYLE_ERROR
