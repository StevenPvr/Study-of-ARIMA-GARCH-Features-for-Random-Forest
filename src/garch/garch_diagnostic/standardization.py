...
from src.garch.garch_diagnostic.param_extraction import extract_lambda_skew_from_params
...
def standardize_residuals(
    ...
    # Extract lambda_skew if not provided
    if lambda_skew is None:
        # params dict acts as "best" dict for extraction
        lambda_skew = extract_lambda_skew_from_params(
            params, dist=dist, required=(dist.lower() == "skewt")
        )
