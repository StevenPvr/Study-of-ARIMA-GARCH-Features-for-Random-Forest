...
from src.garch.garch_diagnostic.data_loading import load_data_and_params
...
def _save_ljung_box_squared_results(
    ...
    """
    from src.garch.garch_diagnostic.advanced_diagnostics import compute_ljung_box_at_specific_lags
...
def _run_ljung_box_test_squared(
    ...
    """
    _save_ljung_box_squared_results(resid_test, best_params, (dist or "normal"), nu)
