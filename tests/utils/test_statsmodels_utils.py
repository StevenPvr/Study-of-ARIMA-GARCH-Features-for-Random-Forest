...
manages statsmodels warning suppression during ARIMA/SARIMA model fitting.
"""
...
class TestSuppressStatsmodelsWarningsUsage:
    ...
    def test_usage_before_model_fitting(self) -> None:
        """Test typical usage pattern before fitting SARIMA models."""
        # Simulate typical usage
        suppress_statsmodels_warnings()

        # In actual usage, user would fit SARIMA model here
    ...
    def test_usage_in_optimization_loop(self) -> None:
        ...
        for _ in range(10):
            # In actual usage, each iteration would fit a SARIMA model
            pass
