...
def test_egarch_params_from_array_student() -> None:
    """Test create_egarch_params_from_array for student distribution."""
    from src.garch.garch_params.models import create_egarch_params_from_array
...
def test_egarch_params_from_array_skewt() -> None:
    """Test create_egarch_params_from_array for skewt distribution."""
    from src.garch.garch_params.models import create_egarch_params_from_array

    arr = np.array([-5.0, 0.1, 0.0, 0.95, 5.0, 0.1])
    params = create_egarch_params_from_array(arr, o=1, p=1, dist="skewt")
    assert params.nu == 5.0
    assert params.lambda_skew == 0.1
