...
def _import_correlation_module() -> Any:
    ...
    correlation_file = _project_root / "src" / "lightgbm" / "correlation" / "correlation.py"
...
def _create_test_datasets(
    ...
    """Create five test datasets for correlation testing."""
    ...
    return complete_path, without_path, log_volatility_path, sigma_path, insights_only_path
