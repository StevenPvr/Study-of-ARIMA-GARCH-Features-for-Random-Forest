...
def _setup_evaluation_paths(
    ...
    monkeypatch.setattr(eval_module, "LIGHTGBM_DATASET_SIGMA_PLUS_BASE_FILE", mock_dataset)
    monkeypatch.setattr(eval_module, "LIGHTGBM_DATASET_LOG_VOLATILITY_ONLY_FILE", mock_dataset)
